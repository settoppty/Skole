// Array:
let list = [
  { name: "Cornflakes", price: 23.5, category: "mat" },
  { name: "Knekkebrød", price: 15.9, category: "mat" },
  { name: "Eplejuice", price: 30.0, category: "mat" },
  { name: "Yoghurt", price: 12.5, category: "mat" },
  { name: "Gulrot", price: 2.5, category: "mat" },
  { name: "Lego sett", price: 250.0, category: "leker" },
  { name: "Fotball", price: 120.0, category: "leker" },
  { name: "Brettspill", price: 299.0, category: "leker" },
  { name: "Dukke", price: 150.0, category: "leker" },
  { name: "Puslespill", price: 100.0, category: "leker" },
  { name: "Toalettpapir", price: 40.0, category: "huskeliste" },
  { name: "Tannkrem", price: 35.0, category: "huskeliste" },
  { name: "Vaskemiddel", price: 89.0, category: "huskeliste" },
  { name: "Batterier", price: 45.0, category: "huskeliste" },
  { name: "Glødepærer", price: 60.0, category: "huskeliste" },
];
