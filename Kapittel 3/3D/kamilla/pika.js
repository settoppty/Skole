...
function pikachumove() {
  if ((CharmLife = false)) return console.log("Charmander has Perished.");
  ...
  if (angrep === 0) {
    ...
    if (CharmanderHealth < 1)
      console.log("Charmander has perished. Pikachu wins.");
    CharmLife = false;
    if (CharmanderHealth < -15) console.log("Okay, that's enough.");
  } else if (angrep === 1) {
...
function charmandermove() {
  ...
  if (angrep === 0) {
    ...
    if (PikaHealth < 1) console.log("Pikachu has perished. Charmander wins.");
    if (CharmanderHealth < 1)
      console.log("Charmander has perished. Pikachu wins.");
    if (PikaHealth < -16) console.log("Okay, that's enough.");
  } else if (angrep === 1) {
